    ...
    <nav class="bg-gray-100 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-900 dark:border-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex pb-2 md:order-2 justify-center mt-4 space-x-6 sm:mt-0">
                <!--Github-->
                <a href="https://github.com/jamiedovaston" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
                ...
                <!--LinkedIn-->
                <a href="https://www.linkedin.com/in/jamie-dovaston-814b71273/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
